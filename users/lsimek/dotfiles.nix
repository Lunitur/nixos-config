...
{
  home.file = {
    ".config/qtile".source = ../../dotfiles/qtile-light;
    ".config/picom".source = ../../dotfiles/picom;
    ".config/nushell/startup.nu".source = ../../dotfiles/nushell/startup.nu;
    ...
    ".config/hypr/lsimek.conf".source = ../../dotfiles/hypr/lsimek.conf;
  };
}
