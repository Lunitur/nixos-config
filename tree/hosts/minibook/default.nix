{ config, ... }: {
  flake.modules.nixos.hosts.minibook.default = { config, lib, pkgs, pkgs-unstable, ... }:
  {
    imports = [
      config.flake.modules.nixos.hosts.minibook.hardware
      config.flake.modules.nixos.hosts.minibook.monitor
