...
{
  flake.modules.nixos.victus-base = {
    config,
    lib,
    pkgs,
    ...
  ...
  {
    imports = [
      inputs.self.modules.nixos.victus-gputoggle
      inputs.self.modules.nixos.victus-hardware
      inputs.self.modules.nixos.victus-vfio
      inputs.self.modules.nixos.victus-kvmfr
      inputs.self.modules.nixos.victus-nvidia
